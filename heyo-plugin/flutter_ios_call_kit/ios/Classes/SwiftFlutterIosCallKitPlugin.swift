//
//  SwiftFlutterIosCallKitPlugin.swift
//  flutter_ios_call_kit
//
//  Created by Hoorad Ramezani on 3/1/2024.
...
@available(iOS 10.0, *)
public class SwiftFlutterIosCallKitPlugin: NSObject, FlutterPlugin, CXProviderDelegate {

    static let ACTION_DID_UPDATE_DEVICE_PUSH_TOKEN_VOIP = "flutter_ios_call_kit.DID_UPDATE_DEVICE_PUSH_TOKEN_VOIP"

    static let ACTION_CALL_INCOMING = "flutter_ios_call_kit.ACTION_CALL_INCOMING"
    static let ACTION_CALL_START = "flutter_ios_call_kit.ACTION_CALL_START"
    static let ACTION_CALL_ACCEPT = "flutter_ios_call_kit.ACTION_CALL_ACCEPT"
    static let ACTION_CALL_DECLINE = "flutter_ios_call_kit.ACTION_CALL_DECLINE"
    static let ACTION_CALL_ENDED = "flutter_ios_call_kit.ACTION_CALL_ENDED"
    static let ACTION_CALL_TIMEOUT = "flutter_ios_call_kit.ACTION_CALL_TIMEOUT"
    static let ACTION_CALL_CUSTOM = "flutter_ios_call_kit.ACTION_CALL_CUSTOM"

    static let ACTION_CALL_TOGGLE_HOLD = "flutter_ios_call_kit.ACTION_CALL_TOGGLE_HOLD"
    static let ACTION_CALL_TOGGLE_MUTE = "flutter_ios_call_kit.ACTION_CALL_TOGGLE_MUTE"
    static let ACTION_CALL_TOGGLE_DMTF = "flutter_ios_call_kit.ACTION_CALL_TOGGLE_DMTF"
    static let ACTION_CALL_TOGGLE_GROUP = "flutter_ios_call_kit.ACTION_CALL_TOGGLE_GROUP"
    static let ACTION_CALL_TOGGLE_AUDIO_SESSION = "flutter_ios_call_kit.ACTION_CALL_TOGGLE_AUDIO_SESSION"

    @objc public private(set) static var sharedInstance: SwiftFlutterIosCallKitPlugin!
    ...
    public static func sharePluginWithRegister(with registrar: FlutterPluginRegistrar) {
        if(sharedInstance == nil){
            sharedInstance = SwiftFlutterIosCallKitPlugin(messenger: registrar.messenger())
        }
    ...
    private static func createMethodChannel(messenger: FlutterBinaryMessenger) -> FlutterMethodChannel {
        return FlutterMethodChannel(name: "flutter_ios_call_kit", binaryMessenger: messenger)
    }

    private static func createEventChannel(messenger: FlutterBinaryMessenger) -> FlutterEventChannel {
        return FlutterEventChannel(name: "flutter_ios_call_kit_events", binaryMessenger: messenger)
    }
    ...
    @objc public func setDevicePushTokenVoIP(_ deviceToken: String) {
        ...
        self.sendEvent(SwiftFlutterIosCallKitPlugin.ACTION_DID_UPDATE_DEVICE_PUSH_TOKEN_VOIP, ["deviceTokenVoIP":deviceToken])
    }
    ...
    @objc public func showCallkitIncoming(_ data: Data, fromPushKit: Bool) {
        ...
        self.sharedProvider?.reportNewIncomingCall(with: uuid!, update: callUpdate) { error in
            if(error == nil) {
                ...
                self.sendEvent(SwiftFlutterIosCallKitPlugin.ACTION_CALL_INCOMING, data.toJSON())
    ...
    @objc public func endCall(_ data: Data) {
        ...
        if(self.isFromPushKit){
            ...
            self.sendEvent(SwiftFlutterIosCallKitPlugin.ACTION_CALL_ENDED, data.toJSON())
        }else {
    ...
    func callEndTimeout(_ data: Data) {
        ...
        sendEvent(SwiftFlutterIosCallKitPlugin.ACTION_CALL_TIMEOUT, data.toJSON())
    ...
    public func provider(_ provider: CXProvider, perform action: CXStartCallAction) {
        ...
        self.callManager.addCall(call)
        self.sendEvent(SwiftFlutterIosCallKitPlugin.ACTION_CALL_START, self.data?.toJSON())
        action.fulfill()
    }
    ...
    public func provider(_ provider: CXProvider, perform action: CXAnswerCallAction) {
        ...
        sendEvent(SwiftFlutterIosCallKitPlugin.ACTION_CALL_ACCEPT, self.data?.toJSON())
        if let appDelegate = UIApplication.shared.delegate as? CallkitIncomingAppDelegate {
    ...
    public func provider(_ provider: CXProvider, perform action: CXEndCallAction) {
        guard let call = self.callManager.callWithUUID(uuid: action.callUUID) else {
            if(self.answerCall == nil && self.outgoingCall == nil){
                sendEvent(SwiftFlutterIosCallKitPlugin.ACTION_CALL_TIMEOUT, self.data?.toJSON())
            } else {
                sendEvent(SwiftFlutterIosCallKitPlugin.ACTION_CALL_ENDED, self.data?.toJSON())
            }
            action.fail()
            return
        }
        ...
        if (self.answerCall == nil && self.outgoingCall == nil) {
            sendEvent(SwiftFlutterIosCallKitPlugin.ACTION_CALL_DECLINE, self.data?.toJSON())
            if let appDelegate = UIApplication.shared.delegate as? CallkitIncomingAppDelegate {
                appDelegate.onDecline(call)
            }
            action.fulfill()
        }else {
            sendEvent(SwiftFlutterIosCallKitPlugin.ACTION_CALL_ENDED, call.data.toJSON())
            if let appDelegate = UIApplication.shared.delegate as? CallkitIncomingAppDelegate {
    ...
    public func provider(_ provider: CXProvider, perform action: CXSetGroupCallAction) {
        ...
        self.sendEvent(SwiftFlutterIosCallKitPlugin.ACTION_CALL_TOGGLE_GROUP, [ "id": action.callUUID.uuidString, "callUUIDToGroupWith" : action.callUUIDToGroupWith?.uuidString])
        action.fulfill()
    }
    ...
    public func provider(_ provider: CXProvider, perform action: CXPlayDTMFCallAction) {
        ...
        self.sendEvent(SwiftFlutterIosCallKitPlugin.ACTION_CALL_TOGGLE_DMTF, [ "id": action.callUUID.uuidString, "digits": action.digits, "type": action.type ])
        action.fulfill()
    }
    ...
    public func provider(_ provider: CXProvider, didActivate audioSession: AVAudioSession) {
        ...
        self.sendEvent(SwiftFlutterIosCallKitPlugin.ACTION_CALL_TOGGLE_AUDIO_SESSION, [ "isActivate": true ])
    }
    ...
    public func provider(_ provider: CXProvider, didDeactivate audioSession: AVAudioSession) {
        ...
        self.sendEvent(SwiftFlutterIosCallKitPlugin.ACTION_CALL_TOGGLE_AUDIO_SESSION, [ "isActivate": false ])
    }

    private func sendMuteEvent(_ id: String, _ isMuted: Bool) {
        self.sendEvent(SwiftFlutterIosCallKitPlugin.ACTION_CALL_TOGGLE_MUTE, [ "id": id, "isMuted": isMuted ])
    }

    private func sendHoldEvent(_ id: String, _ isOnHold: Bool) {
        self.sendEvent(SwiftFlutterIosCallKitPlugin.ACTION_CALL_TOGGLE_HOLD, [ "id": id, "isOnHold": isOnHold ])
    }
