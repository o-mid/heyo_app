...
class RecordIndicatorWidget extends StatelessWidget implements PreferredSizeWidget {
  ...
  Size get preferredSize => Size(
        double.infinity,
        Get.find<CallController>().recordState.value == RecordState.notRecording ? 0 : 34,
      );
}
