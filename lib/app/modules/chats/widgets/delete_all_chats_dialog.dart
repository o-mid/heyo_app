  ...
  Widget build(BuildContext context) {
    return ModifiedAlertDialog(
      alertContent: DefaultAlertDialogContent(
        ...
        title: LocaleKeys.HomePage_Chats_deleteAllchatsDialog_title.tr,
        buttons: [
          CustomButton(
            onTap: () {
              Get.back(result: true);
            },
            title: LocaleKeys.HomePage_Chats_deleteAllchatsDialog_delete.tr,
          ...
          CustomButton(
            ...
            title: LocaleKeys.HomePage_Chats_deleteAllchatsDialog_cancel.tr,
            textStyle: TEXTSTYLES.kLinkBig.copyWith(color: COLORS.kDarkBlueColor),
          ),
        ],
      ),
