...
class $AssetsSvgGen {
  ...
  SvgGenImage get blockedUser =>
      const SvgGenImage('assets/svg/blocked_user.svg');
  ...
  /// File path: assets/svg/call_disconnected.svg
  SvgGenImage get callDisconnected =>
      const SvgGenImage('assets/svg/call_disconnected.svg');
  ...
  SvgGenImage get outgoingCall =>
      const SvgGenImage('assets/svg/outgoing_call.svg');
  ...
  SvgGenImage get qrCode => const SvgGenImage('assets/svg/qr_code.svg');
  ...
  SvgGenImage get removeContact =>
      const SvgGenImage('assets/svg/remove_contact.svg');
  ...
  /// File path: assets/svg/verified_with_blue_padding.svg
