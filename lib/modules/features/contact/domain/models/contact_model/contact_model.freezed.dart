...
class _$ContactModelImpl implements _ContactModel {
  const _$ContactModelImpl({required this.coreId, required this.name});
  ...
  @override
  String toString() {
    return 'ContactModel(coreId: $coreId, name: $name)';
  }
...
abstract class _ContactModel implements ContactModel {
  const factory _ContactModel(
      ...
      required final String name}) = _$ContactModelImpl;
